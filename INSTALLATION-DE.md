# KASC Cards 1.3.2 aktualisieren

Die neuen Cards binden KASC 6.7.17 und VASC 3.0.34 ein. Alte versiegelte Cards bleiben an ihre alten Mod-Versionen gebunden; deshalb auch die Card selbst aktualisieren.
...
3. [Card 1.3.2 für Rot, Blau oder Gelb](https://github.com/Roxas2712/kasc-cards/releases/tag/v1.3.2) importieren. Die vorhandene Card derselben Edition aktualisieren; ihre ID bleibt gleich.
4. Beide gebundenen Mods installieren/aktualisieren: KASC 6.7.17 und VASC 3.0.34. Spiel vollständig neu starten.
