...
for _,edition in ipairs({'red','blue','yellow'})do
 local cart=assert(C.decode(read(repo..'/cards/kanto-ascendant-'..edition..'-1.3.2.g1rcart')))
 cart.version='1.3.3'
 ...
 assert(C.publishable(cart));write(repo..'/cards/kanto-ascendant-'..edition..'-1.3.3.g1rcart',C.encode(cart))
 print('BUILT '..edition..' 1.3.3')
end
