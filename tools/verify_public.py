...
def check(line):
    ...
    for repo,tag in [('kasc-cards','v1.3.0-rc.19'),('voxel-ascendant','v3.0.13')]:
...
if __name__=='__main__':
    ...
    release=json.loads(get('https://api.github.com/repos/Roxas2712/kasc-cards/releases/tags/v1.3.0-rc.19'))
    ...
    assert latest['tag_name']=='v1.3.0-rc.19'
