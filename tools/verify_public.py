...
def check(line):
    ...
    for repo,tag in [('kasc-cards','v1.3.0-rc.10'),('kanto-ascendant','v6.7.0-rc.8')]:
...
if __name__=='__main__':
    ...
    release=json.loads(get('https://api.github.com/repos/Roxas2712/kasc-cards/releases/tags/v1.3.0-rc.10'))
    ...
    assert latest['tag_name']=='v1.3.0-rc.10'
